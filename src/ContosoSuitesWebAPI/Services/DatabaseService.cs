...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        ...
        [Description("The starting date of the hotel stay")] DateTime dt
        )
    {
    ...
    [KernelFunction]
    [Description("Get Hotel Books that do not have an assigned room.")]
    ...
    [KernelFunction]
    [Description("Get a single hotel booking that has multiple hotel rooms.")]
